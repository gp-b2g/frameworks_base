...
*/
    ...
    int RIL_REQUEST_DIAL_VT = 127;
    int RIL_REQUEST_HANGUP_VT = 128;
    int RIL_REQUEST_ANSWER_VT = 129;
	int RIL_REQUEST_ENABLE_ENGINEER_MODE = 130;
    ...
    int RIL_UNSOL_CALL_RING_VT = 1044;
	int RIL_UNSOL_ENGINEER_MODE = 1045;
}
